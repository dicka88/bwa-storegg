  ...
  return (
    <section className="sidebar">
      <div className="content pt-50 pb-30 ps-30">
        ...
        <div className="menus">
          <div className={`item mb-30 ${path === '/member/overview' ? 'active' : ''}`}>
            <svg
              className="icon me-3"
              width="25"
              height="25"
            ...
            <p className="item-title m-0">
              <Link href="/member/overview" passHref>
                <a href="/member/overview" className="text-lg text-decoration-none">Overview</a>
              </Link>
            </p>
          </div>
          <div className={`item mb-30 ${path === '/member/transactions' ? 'active' : ''}`}>
            <svg
              className="icon me-3"
              width="25"
              height="25"
            ...
            <p className="item-title m-0">
              <Link href="/member/transactions" passHref>
                <a href="/member/transactions" className="text-lg text-decoration-none">Transactions</a>
              </Link>
            </p>
          </div>
          <div className={`item mb-30 ${path === '/member/messages' ? 'active' : ''}`}>
            <svg
              className="icon me-3"
              width="25"
              height="25"
            ...
            <p className="item-title m-0">
              <Link href="/member/messages" passHref>
                <a href="/member/messages" className="text-lg text-decoration-none">Messages</a>
              </Link>
            </p>
          </div>
          <div className={`item mb-30 ${path === '/member/card' ? 'active' : ''}`}>
            <svg
              className="icon me-3"
              width="25"
              height="25"
            ...
            <p className="item-title m-0">
              <Link href="/member/card" passHref>
                <a href="/member/card" className="text-lg text-decoration-none">Card</a>
              </Link>
            </p>
          </div>
          <div className={`item mb-30 ${path === '/member/rewards' ? 'active' : ''}`}>
            <svg
              className="icon me-3"
              width="25"
              height="25"
            ...
            <p className="item-title m-0">
              <Link href="/member/rewards" passHref>
                <a href="/member/rewards" className="text-lg text-decoration-none">Rewards</a>
              </Link>
            </p>
          </div>
          <div className={`item mb-30 ${path === '/member/settings' ? 'active' : ''}`}>
            <svg
              className="icon me-3"
              width="25"
              height="25"
            ...
            <p className="item-title m-0">
              <Link href="/member/settings" passHref>
                <a href="/member/settings" className="text-lg text-decoration-none">Settings</a>
              </Link>
            </p>
          </div>
          <div className="item mb-30">
            ...
            <p className="item-title m-0">
              <a href="/#" className="text-lg text-decoration-none" onClick={handleLogout}>Log Out</a>
            </p>
          </div>
        </div>
